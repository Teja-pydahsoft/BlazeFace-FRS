"""
Test face recognition with the new simple embedder
"""
...
def test_new_recognition():
    """Test face recognition with new simple embedder"""
    try:
        print("Testing Face Recognition with Simple Embedder...")
        ...
        while frame_count < 100:  # Test for 100 frames
            ...
            # Display frame
            cv2.imshow('New Recognition Test', frame_with_faces)
        ...
        print("New recognition test completed")
        
    except Exception as e:
        print(f"Error in new recognition test: {e}")
        import traceback
        traceback.print_exc()

if __name__ == "__main__":
    test_new_recognition()

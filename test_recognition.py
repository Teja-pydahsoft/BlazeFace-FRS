"""
Test face recognition with stored encodings
"""
...
def test_recognition():
    ...
    try:
        ...
        while frame_count < 100:  # Test for 100 frames
                        ...
                        if embedding is not None:
                            ...
                            for student_id, encodings_list in student_encodings.items():
                                for stored_encoding in encodings_list:
                                    is_same, similarity = embedder.compare_faces(embedding, stored_encoding, 0.6)
                                    print(f"    Comparing with {student_id}: is_same={is_same}, similarity={similarity:.4f}")
            ...
            # Display frame
            cv2.imshow('Face Recognition Test', frame_with_faces)
